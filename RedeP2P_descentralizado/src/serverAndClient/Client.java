...
public class Client {
    ...
    */
    public Client (String host, int porta) throws IOException {
        this.host = host;
        this.porta = porta;
        this.conexao();
    }
    
    /**Método para conectar o cliente ao servidor, este método é ao clicar um novo objeto do tipo Client.
    *  @author Samuel Vitorio Lima e Gabriel Sá Barreto 
    */
